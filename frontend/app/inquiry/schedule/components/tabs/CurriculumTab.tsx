    ...
    <div className="space-y-3 mt-0">
      ...
      <div className="space-y-3">
        {modules.map((module, i) => (
          <div
            key={i}
            className="rounded-lg border border-gray-700 bg-gray-900 overflow-hidden shadow-sm hover:shadow-md transition-shadow"
          >
            <div className="flex gap-4 p-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="space-y-1.5 pl-11">
                  <h4 className="text-xs font-semibold text-gray-400 mb-2">학습 내용</h4>
              ...
              {module.image && (
                <div className="flex-shrink-0 w-32">
                  <div className="aspect-square w-full overflow-hidden rounded-lg bg-gray-800 border border-gray-700">
