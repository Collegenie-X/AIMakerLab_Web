              ...
              <table className="w-full">
                ...
                <thead>
                  <tr className="bg-gradient-to-r from-orange-400 to-orange-500">
                    ...
                    <th className="px-4 py-4 text-center text-white font-bold border-r border-orange-600 bg-yellow-400 text-gray-800">
                      {data.headers[1]}
                    </th>
                    <th className="px-4 py-4 text-center text-white font-bold border-r border-orange-600 bg-cyan-400">
                      {data.headers[2]}
                    </th>
                    <th className="px-4 py-4 text-center text-white font-bold border-r border-orange-600 bg-cyan-500">
                      {data.headers[3]}
                    </th>
                    <th className="px-4 py-4 text-center text-white font-bold border-r border-orange-600 bg-blue-500">
                      {data.headers[4]}
                    </th>
                    <th className="px-4 py-4 text-center text-white font-bold bg-indigo-600">
                      {data.headers[5]}
                    </th>
                  </tr>
                </thead>
                      ...
                      {gradeKeys.map((gradeKey) => {
                        ...
                        return (
                          ...
                          >
                            {recommendation ? (
                              <div
                                className={`inline-flex items-center justify-center px-4 py-2 rounded-full font-bold text-sm min-w-[80px] ${style}`}
                              >
                                {recommendation}
                              </div>
                            ) : (
