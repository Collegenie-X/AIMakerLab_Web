  ...
  return (
    <CurriculumSectionContainer className="py-16 bg-gray-950" containerClass={containerClass}>
      ...
      <div className="grid gap-6 md:grid-cols-2 mb-12">
        {goals.map((goal) => (
          <Card key={goal.id} className="hover:shadow-lg transition-shadow bg-gray-900 border-gray-700">
            <CardContent className="pt-6">
              <Badge className={`mb-3 bg-${primaryColor}-900/30 text-${primaryColor}-400 hover:bg-${primaryColor}-900/30`}>
                {goal.category}
              </Badge>
