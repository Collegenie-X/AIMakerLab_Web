...
export function GradeRecommendationTable({ data }: GradeRecommendationTableProps) {
  ...
  return (
    <section className="py-12 bg-gradient-to-br from-gray-900/80 via-gray-900 to-gray-900/80">
      <div>
                    ...
                    >
                      ...
                      <td className="px-6 py-5 border-r border-gray-700">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="font-bold text-white mb-1">{course.courseName}</div>
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-4">
            <div className="flex items-start gap-3 p-4 bg-gray-900 rounded-lg shadow-sm">
              ...
              <div className="flex-1">
                <p className="text-sm text-gray-300">{data.legend.recommended}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-gray-900 rounded-lg shadow-sm">
              ...
              <div className="flex-1">
                <p className="text-sm text-gray-300">{data.legend.optional}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-gray-900 rounded-lg shadow-sm">
              ...
              <div className="flex-1">
                <p className="text-sm text-gray-300">{data.legend.challenge}</p>
              </div>
            </div>
          </div>
