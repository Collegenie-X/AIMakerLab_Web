    ...
    <section className="border-t border-gray-700 bg-gray-950 py-10">
      <div className="container mx-auto max-w-6xl px-4">
        <div className="mb-8 text-center">
          ...
          <h2 className="mb-2 text-3xl font-bold text-white">실제 수업 활동 사진</h2>
          <p className="text-gray-400">학생들이 직접 만들고 배우는 생생한 현장</p>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {photos.map((photo, index) => (
            <div
              key={index}
              className="group cursor-pointer overflow-hidden rounded-xl border-2 border-gray-700 bg-gray-900 shadow-md transition-all hover:scale-[1.03] hover:shadow-xl"
            ...
            >
              ...
              {/* 설명 */}
              <div className="p-4">
                <h3 className="mb-2 font-bold text-white">{photo.title}</h3>
                <p className="line-clamp-2 text-sm text-gray-400">{photo.description}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-8 rounded-xl border border-orange-800 bg-orange-950/30 p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="mb-2 font-bold text-orange-300">실제 교육 현장</h4>
