    ...
    <section className="border-t bg-gradient-to-br from-green-50 to-emerald-50 py-10">
      <div className="container mx-auto max-w-6xl px-4">
        <div className="mb-8 text-center">
          ...
          <h2 className="mb-2 text-3xl font-bold text-gray-900">수업 과정 ({curriculum.length}차시)</h2>
          <p className="text-gray-600">단계별로 체계적인 메이커 교육 과정</p>
        </div>
        ...
        <div className="mt-8 rounded-xl border border-green-200 bg-green-50 p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="mb-2 font-bold text-green-900">교육 시간 안내</h4>
        ...
        <div className="mt-6 rounded-xl border-2 border-emerald-200 bg-white p-6 shadow-sm">
          <div className="flex flex-col items-center gap-3 text-center md:flex-row md:justify-between md:text-left">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="font-bold text-gray-900">수업 자료 PDF 다운로드</h4>
