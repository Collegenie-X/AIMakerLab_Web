    ...
    <section className="border-t border-gray-700 bg-gray-900 py-10">
      <div className="container mx-auto max-w-6xl px-4">
        <div className="mb-8 text-center">
          <h2 className="mb-2 text-3xl font-bold text-white">제품 사용 동영상</h2>
          <p className="text-gray-400">실제 수업에서 어떻게 활용되는지 영상으로 확인하세요</p>
        </div>

        <div className="mx-auto max-w-4xl">
          <div className="relative aspect-video overflow-hidden rounded-2xl border-2 border-gray-700 bg-black shadow-2xl">
            {/* 동영상 썸네일 */}
            <img
