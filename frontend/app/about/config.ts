 ...
 * 
 * 컨텐츠는 JSON 파일(/public/about/about-content.json)로 이동되었습니다.
 * hooks/useAboutContent.ts를 사용하여 컨텐츠를 불러오세요.
 * 
...
export const facilitySectionContent: FacilitySectionContent = {
  ...
  stats: [
    ...
    { value: '10+', label: '교육용 키트 종류', theme: 'green' },
    { value: '8명', label: '최대 수업 인원', theme: 'purple' },
